...
\begin{enumerate}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[scale=1.2, width=0.9\textwidth]{simple}
        $$M(X, Y) = 0.00857143$$
    \end{figure}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[scale=1.2, width=0.9\textwidth]{unequal}
        $$M(X, Y) = 2.016$$
    \end{figure}
...
\newpage
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[scale=1.2, width=0.9\textwidth]{sin}
        $$M(X, Y) = 3.69459e-05$$
    \end{figure}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[scale=1.2, width=0.9\textwidth]{cont}
        $$M(X, Y) = 0.315604$$
    \end{figure}
...
\begin{enumerate}
    \item Обратим внимание, что на последнем примере наш алгоритм показал
    не совсем ожидаемый результат. В самом начале образовался "веер".
    То есть большая часть второй последовательности отобразилась в одну
    точку первой. Иначе говоря $x_j \mapsto {y_i,\ldots,y_i+k}$. Почему так произошло?

    Посмотрим чему соответствует такое поведение, опираясь на замечание
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[scale=1.2, width=0.9\textwidth]{cont2}
        $$M(X, Y) = 0.182037$$
    \end{figure}
